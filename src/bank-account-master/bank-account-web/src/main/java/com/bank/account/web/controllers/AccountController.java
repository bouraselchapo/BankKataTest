...
public class AccountController {
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  public Account depositAmount(AccountModel accountModel) {
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  public Set<Transaction> getTransactionsHistory(AccountModel accountModel) {
    return null;
  }
  ...
  @Consumes({MediaType.APPLICATION_JSON})
  @Produces({MediaType.APPLICATION_JSON})
  public Account withdrawdAmount(AccountModel accountModel) {
