 ...
 * 
 * ● Write some code to keep a record of the transfer for both bank accounts in a transaction
 * history
 *
 * @author HICHAM BOURAS
 *
...
public class TransactionTransferKeepTraceFeatureTest {
  ...
  @Test
  public void keepMoneyTransferTransactionTraceTest() {
